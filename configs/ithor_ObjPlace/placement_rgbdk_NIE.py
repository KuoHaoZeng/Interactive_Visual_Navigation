...
from interactive_navigation.models import PlacementRGBDKNIEActorCriticSimpleConvRNN
...
class PlacementRGBDKNIEConfig(PlacementBaseConfig):
    def __init__(self):
        super().__init__()
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PlacementRGBDKNIEActorCriticSimpleConvRNN(
