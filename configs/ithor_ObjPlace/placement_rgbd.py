...
from interactive_navigation.models import PlacementRGBDActorCriticSimpleConvRNN
...
class PlacementRGBDConfig(PlacementBaseConfig):
    def __init__(self):
        super().__init__()
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PlacementRGBDActorCriticSimpleConvRNN(
