...
from interactive_navigation.models import ObstaclesNavRGBDSActorCriticSimpleConvRNN
...
class ObstaclesNavRGBDSConfig(ObstaclesNavBaseConfig):
    def __init__(self):
        super().__init__()
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ObstaclesNavRGBDSActorCriticSimpleConvRNN(
